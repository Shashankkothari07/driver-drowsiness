...
predictor = dlib.shape_predictor(r"C:\Users\kotha\OneDrive\Desktop\project driver\shape_predictor_68_face_landmarks.dat")
...
def main():
	cap = cv2.VideoCapture(r"C:\Users\kotha\OneDrive\Desktop\project driver\VID-20200211-WA0012.mp4")
	sleep = 0
	drowsy = 0
	active = 0
	status=""
		...
		for face in faces:
			...
			if(left_blink==0 or right_blink==0):
				...
				if(sleep>6):
						...
						color = (255,0,0)
						mixer.init()
						mixer.music.load(r"C:\Users\kotha\OneDrive\Desktop\project driver\warning.mp3")
				...
				if(drowsy>8):
						...
						color = (0,0,255)
						mixer.init()
						mixer.music.load(r"C:\Users\kotha\OneDrive\Desktop\project driver\warning_yawn.mp3")
						mixer.music.play()
						while mixer.music.get_busy():  # wait for music to finish playing
							time.sleep(0)
			else:
